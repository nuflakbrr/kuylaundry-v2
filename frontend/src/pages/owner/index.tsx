...
const LoginOwner: FC = () => {
    ...
    axios
      ...
      .then((res) => {
        if (res.data.logged === true) {
          ...
          localStorage.setItem('pemilik', JSON.stringify(owner));
  ...
  return (
    <>
      <Head>
        <title>Masuk Pemilik - KuyLaundry</title>
      </Head>
          ...
          <div className="max-w-xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
            <div className="container bg-slate-100 dark:bg-white rounded p-5">
              <div className="text-center">
                <h1 className="font-bold text-xl text-black">Masuk Pemilik</h1>
              </div>
